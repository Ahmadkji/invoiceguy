...
const painPoints = [
  ...
  },
  {
    ...
    solution: "Tiny Task Mode lets you quickly log small work items. Your billing rule ensures nothing is underbilled.",
  ...
  },
  {
    ...
    solution: "Set your billing rule once. Every entry automatically calculates actual vs billed time with full transparency.",
