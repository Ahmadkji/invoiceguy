...
function DetailRow({
  ...
  return (
    <div
      className={cn(
        "grid grid-cols-[minmax(0,150px)_1fr] gap-4 border-b border-[#d9c3a1]/45 py-4 text-sm sm:grid-cols-[160px_1fr] print:grid-cols-[110px_1fr] print:gap-2 print:py-2 print:text-[10px]",
        className
      )}
    >
      <span className="text-[11px] font-semibold uppercase tracking-[0.28em] text-[#9f7d4f] print:text-[9px] print:tracking-[0.12em]">
        {label}
      </span>
      <span className="break-words text-base text-[#2c241b] print:text-[10px]">{value}</span>
    </div>
  );
}
...
function InfoRow({
  ...
  return (
    <div className="flex items-start gap-3 text-sm text-[#4c4033] print:gap-2 print:text-[10px]">
      <div className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#f5eee4] text-[#b99158] print:h-6 print:w-6">
        <Icon aria-hidden="true" className="h-4 w-4 print:h-3 print:w-3" />
      </div>
...
function InvoiceStatusPill({
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 print:gap-1">
      <span className="inline-flex items-center rounded-full bg-[#f2e5d0] px-4 py-1.5 text-sm font-medium text-[#7a5d35] print:px-2 print:py-0.5 print:text-[10px]">
        {label}
      </span>
      {overdue ? (
        <span className="inline-flex items-center rounded-full border border-[#dfb0aa] bg-[#fff1ef] px-3 py-1 text-xs font-semibold uppercase tracking-[0.16em] text-[#b24f41] print:px-2 print:py-0.5 print:text-[9px] print:tracking-[0.08em]">
          Overdue
        </span>
      ) : null}
    </div>
          ...
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_1.15fr] lg:items-start print:grid-cols-[0.85fr_1.15fr] print:gap-6">
            <div className="space-y-6 print:space-y-4">
              <div className="space-y-4 print:break-inside-avoid print:space-y-2">
                ...
                <div>
                  <h2 className="break-words font-serif text-4xl text-[#16120f] sm:text-[3.35rem] print:text-2xl">
                    {presentation.businessName}
                  </h2>
                  {presentation.contactName ? (
                    <p className="mt-1 text-base text-[#776250] print:text-[10px]">{presentation.contactName}</p>
                  ) : null}
                </div>
              ...
              <div className="rounded-[24px] border border-white/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.85),rgba(250,242,230,0.78))] p-6 shadow-[0_18px_50px_rgba(188,151,98,0.1)] print:break-inside-avoid print:rounded-xl print:p-4 print:shadow-none">
                ...
                <div className="mt-4 h-px w-full bg-[#ddc6a5] print:mt-2" />
                <div className="mt-4 space-y-3 print:mt-3 print:space-y-2">
                  <h3 className="break-words font-serif text-3xl text-[#17120d] print:text-xl">{presentation.clientName}</h3>
                  {presentation.clientCompany ? (
                    <p className="break-words text-sm text-[#7a6654] print:text-[10px]">{presentation.clientCompany}</p>
                  ) : null}
                  <div className="space-y-2 text-sm text-[#4f4337] print:text-[10px]">
            ...
            <div className="print:break-inside-avoid">
              <div className="pb-6 print:pb-3">
                ...
                <div className="mt-4 flex items-center gap-3 text-[#c29a62] print:mt-2 print:gap-2">
                  <div className="h-px flex-1 bg-[#d8bf9a]" />
                  <span aria-hidden="true" className="text-lg print:text-xs">*</span>
                  <div className="h-px flex-1 bg-[#d8bf9a]" />
                </div>
              </div>

              <div className="grid gap-8 lg:grid-cols-[1px_minmax(0,1fr)] print:grid-cols-[1px_minmax(0,1fr)] print:gap-4">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-[minmax(0,150px)_1fr] gap-4 border-b border-[#d9c3a1]/45 py-4 text-sm sm:grid-cols-[160px_1fr] print:grid-cols-[110px_1fr] print:gap-2 print:py-2 print:text-[10px]">
                    <span className="text-[11px] font-semibold uppercase tracking-[0.28em] text-[#9f7d4f] print:text-[9px] print:tracking-[0.12em]">
                      Status
                    </span>
            ...
            <div className="space-y-8 print:space-y-4">
              <div className="flex items-start gap-4 print:break-inside-avoid print:gap-3">
                ...
                <div>
                  ...
                  <p className="mt-2 break-words text-2xl font-medium leading-tight text-[#231a12] print:text-sm">
                    {presentation.paymentTerms}
                  </p>
                  <p className="mt-2 break-words text-sm leading-6 text-[#675645] print:text-[10px] print:leading-4">
              ...
              <div className="flex items-start gap-4 print:break-inside-avoid print:gap-3">
                ...
                <div>
                  ...
                  <p className="mt-2 break-words text-xl font-medium leading-tight text-[#231a12] print:text-sm">
                    {presentation.notes}
                  </p>
                </div>
              </div>
